...
const BusDetails2screen = ({navigation}) => {
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.tabs}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('BusDetails2screen')} style={styles.tabActive}>
          <Text style={styles.tabTextActive}>Review</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('BusDetails3screen')} style={styles.tab}>
      ...
      <View style={styles.comment}>
        <View style={styles.commentHeader}>
          <Image
           source={require('../images/profile.png')}  // Replace with the user profile image URL
...
export default BusDetails2screen;
